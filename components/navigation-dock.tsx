...
import { CalendarIcon, FileCheck2, Folders, HomeIcon, MailIcon, PencilIcon } from "lucide-react";
...
const DATA = {
  ...
  contact: {
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/alexvieru1",
        icon: Icons.github,
        external: true,
      },
      LinkedIn: {
        name: "LinkedIn",
        url: "https://linkedin.com/in/vieru-alexandru",
        icon: Icons.linkedin,
        external: true,
      },
      Email: {
        name: "Send Email",
        url: "mailto:vieru.alexandruu@gmail.com",
        icon: Icons.email,
        external: false,
      },
    },
